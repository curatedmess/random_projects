...
tree <- ggplot() +
  ...
  annotate(geom = "text", x = 260, y = 778, label = "\n\nChristmas 2022 | Ryan Hart", color = "#F2F2F2", family = font2, size = 1.75, hjust = 0.5) +
  theme_void() +
...
# animate ----------------------------------------=------------------------
animate(animation, width = 1600, height = 1920, res = 320, fps = 25, duration = 10, end_pause = 20)
